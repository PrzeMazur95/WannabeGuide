<x-app-layout>
    ...
    <div class="grid grid-rows-3 grid-flow-col gap-4" id="statistics">
        <div class="row-span-3 bg-white overflow-hidden shadow-sm sm:rounded-lg sm:px-6 lg:px-8 p-6 mx-2 ...">{{ $topicsCount }}</div>
        <div class="col-span-2 bg-white overflow-hidden shadow-sm sm:rounded-lg sm:px-6 lg:px-8 p-6 mx-2 ...">{{ $tagsCount }}</div>
        <div class="row-span-2 bg-white overflow-hidden shadow-sm sm:rounded-lg col-span-2 sm:px-6 lg:px-8 p-6 mx-2 ...">{{ $categoriesCount }}</div>
    </div>
    @section('script')
    <script>
